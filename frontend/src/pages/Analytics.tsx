  ...
  return (
    <div>
      ...
      <div className="analytics-layout">
        ...
        <div className="analytics-chatbot-col">
          <FinancialChatbot />
        </div>

        {/* Right column — Existing analytics panels */}
        <div className="analytics-panels-col">
          {loading ? (
            ...
            <>
              <section className="finflux-panel rounded-xl border border-gray-200 bg-white p-5">
                ...
                {categories.length === 0 ? (
                  <div className="flex h-32 items-center justify-center text-sm text-gray-400">No category data available.</div>
                ) : (
