  ...
  export default function Dashboard() {
    ...
    const load = async () => {
      ...
      const params = {
        ...
        // Include the full selected end date in the existing API filter.
        dateTo: dateTo ? `${dateTo}T23:59:59.999Z` : undefined,
      };
      try {
        const [s, b, m, t, d, f] = await Promise.all([
          ...
          analyticsApi.features(params),
        ]);
        console.log('FINFLUX FINANCIAL FEATURES:', f);
